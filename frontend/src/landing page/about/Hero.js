...
function AboutHero() {
  return (
    <div className="container">
      <div className="row">
        <div className="col text-center p-5 my-5">
          <h3>We pioneered the discount broking model in India.</h3>
          <h3> Now, we are breaking ground with our technology. </h3>
        </div>
        <div className="row  border-top p-5 mt-5 text-muted  " style={{ lineHeight: "1.9", fontSize: "1.05rem" }}>
          <div className="col-12 col-md-6 p-2 p-md-3 text-right ml-5">
          ...
          <div className="col-12 col-md-6 p-2 p-md-3 text-left mr-5">
